...
class ScreeningFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'completed_at' => now(),
            'gestational_age_weeks_snapshot' => $this->faker->numberBetween(6, 32),
            'gestational_age_days_snapshot' => $this->faker->numberBetween(0, 6),
            'total_score' => $this->faker->numberBetween(0, 15),
            'max_score' => 20,
