<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            Jika akun dihapus, seluruh data akun Ibu akan dihapus permanen. Pastikan Ibu benar-benar yakin sebelum melanjutkan.
        </p>
    </header>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600">
                Semua data akun akan dihapus permanen. Masukkan kata sandi untuk mengonfirmasi penghapusan akun Ibu.
            </p>
